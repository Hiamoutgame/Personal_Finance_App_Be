...
CREATE TABLE transactions (
    ...
    from_jar_id                  UUID          NULL REFERENCES jars(id),
    to_jar_id                    UUID          NULL REFERENCES jars(id),
...
CREATE TABLE import_transaction_drafts (
    ...
    edited_category_id      UUID          NULL REFERENCES categories(id),
    edited_jar_id           UUID          NULL REFERENCES jars(id),
...
VALUES
    (1, 'User', 'User', 'Default application user'),
    (2, 'Admin', 'Admin', 'Application administrator')
