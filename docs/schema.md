...
- PostgreSQL.
- Business tables dung `uuid` primary key, default `gen_random_uuid()`.
- Rieng `roles.id` dung `smallint identity`.
...
| --- | --- | --- |
| `id` | `uuid` | PK |
| `actor_account_id` | `uuid` | FK `accounts.id` |
...
| --- | --- | --- |
| `id` | `uuid` | PK |
| `user_id` | `uuid` | unique FK `accounts.id` |
...
| `is_default` | `boolean` | default `false` |
| `owner_user_id` | `uuid` | nullable FK `accounts.id` |
...
| `id` | `uuid` | PK |
| `user_id` | `uuid` | FK `accounts.id` |
| `jar_setup_id` | `uuid` | nullable FK `jar_setups.id` |
| `name` | `varchar(100)` | not null |
...
| `from_jar_id` | `uuid` | nullable FK `jars.id` |
| `to_jar_id` | `uuid` | nullable FK `jars.id` |
...
| `edited_category_id` | `uuid` | nullable FK `categories.id` |
| `edited_jar_id` | `uuid` | nullable FK `jars.id` |
...
| `id` | `uuid` | PK |
| `user_id` | `uuid` | FK `accounts.id` |
| `jar_id` | `uuid` | nullable FK `jars.id` |
| `category_id` | `uuid` | nullable FK `categories.id` |
...
| `linked_jar_id` | `uuid` | nullable FK `jars.id` |
| `note` | `text` | nullable |
| `created_at` | `timestamptz` | default `now()` |
| `updated_at` | `timestamptz` | default `now()` |
...
| `user_id` | `uuid` | FK `accounts.id` |
| `source_jar_id` | `uuid` | nullable FK `jars.id` |
...
| --- | --- | --- |
| `id` | `uuid` | PK |
| `created_by_admin_id` | `uuid` | FK `accounts.id` |
...
| `broadcast_id` | `uuid` | nullable FK `broadcasts.id` |
| `metadata_json` | `json` | nullable |
| `created_at` | `timestamptz` | default `now()` |
...
| --- | --- | --- |
| `id` | `uuid` | PK |
| `updated_by_admin_id` | `uuid` | nullable FK `accounts.id` |
